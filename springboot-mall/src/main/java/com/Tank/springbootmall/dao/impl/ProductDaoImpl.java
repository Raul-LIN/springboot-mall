package com.Tank.springbootmall.dao.impl;
...
import com.Tank.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao{
	...
	public List<Product> getProducts(ProductQueryParams productQueryParams) {
		...
		if(productQueryParams.getSearchString() != null) {
			sql = sql + " AND product_name LIKE :search";
			map.put("search", "%" + productQueryParams.getSearchString() + "%");
		}
	...
	public Integer createProduct(@Valid ProductRequest productRequest) {
		...
		map.put("imageUrl", productRequest.getImgeUrl());
